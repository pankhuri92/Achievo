...
async function fetchTasks() {
    try {
      ...
      if (response.ok) {
        ...
        // Update the task list on your HTML page
  ...
  // Function to update the task list in the HTML document
  function updateTaskList(tasks) {
    ...
    tasks.forEach(task => {
      ...
      li.innerHTML = task.taskName; // Assuming your MySQL table has a column named 'taskName'
...
document.addEventListener('DOMContentLoaded', async () => {
    // Fetch tasks when the DOM content is loaded
    await fetchTasks();
  
    // Rest of your existing code...
  
    // For example, you might want to set up event listeners or perform other actions
  });
